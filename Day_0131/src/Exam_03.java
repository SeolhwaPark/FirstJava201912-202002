...
public class Exam_03 {
	private static final int START_DAT_OF_WEEK = 0;

	public static void main(String[] args) {
		//int cnt = args.length;
		//System.out.println("인자수:"+cnt);
		//개피곤.. ㅜㅠㅠ 시름...ㅠ
		if(args.length!=2) {
		...
		//예를들어, 2015년 11월 1일은 sDay.set(2015,10,1)과 같이 해줘야한다.
		sDay.set(year, month-1,1);
		eDay.set(year, month, 1);
		
		//다음달의 첫날에서 하루를 빼면 현재달의 마지막 날이 된다.
		//12월 1일에서 하루 빼면 11월 30일이 된다
