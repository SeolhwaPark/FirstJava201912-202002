			...
			<div class="content">
				...
				<%
					for(int i=0; i<list.size();i++){
						String outdate="";
						String indate="";
						if(list.get(i).getIndate() != null){
							String yy=list.get(i).getIndate().substring(0,4);
							String mm=list.get(i).getIndate().substring(5,7);
							String dd=list.get(i).getIndate().substring(8,10);
							indate = yy+"년" + mm+"월"+dd+"일"; 
						}
				%>			
							<tr>
								<td class="text_center">
									<a href="loanedit.jsp?lentno=<%= list.get(i).getLentno() %>"><%= list.get(i).getLentno() %></a></td>
								<td class="text_center"><%= list.get(i).getUserno() %></td>
								<td class="text_center"><%= list.get(i).getName() %></td>
								<td class="text_center"><%= list.get(i).getBookname() %></td>
								<td class="text_center"><%= list.get(i).getOutdate() %></td>
								<td class="text_center"><%= indate %></td>
