...
<html lang="ko">
 ...
 -->
	...
	<div class="container">
	  ...
	  <form name="notice" method="post" action="qa_reply">
	  <!-- action을 처리하기전에 check()사용자 함수를 실행하고 되돌아 와라-->
			...
			<div class="btn_wrap">
				...
				<input type="button" value="목록" class="btn_list" onClick="location.href='qa';">
			</div>
		</form>
	  </div>
