 ...
 <body topmargin="0" leftmargin="0">
   <table border="0" width="800">
     <tr>
         ...
         <tr>
           <td class="content">
             <p align="right"><font size="2" face="돋움">
              <a class="list" href="mailto:ein1027@nate.com"><%= vo.getRegdate() %></a> / <font size="2" face="돋움"><%= vo.getName() %> / <%= vo.getReadcnt() %>번 읽음</font>
             <p>
              <%= lineBreak(vo.getContents()) %><p><!--contents의 내용을 <BR>태그로 처리-->
           </td>
         </tr>
       </table>
      ...
      <font size="2">
       <!-- 새글쓰기 -->
       <a href="board_write.jsp?idx=<%=idx %>">
