...
function post_check() {
	window.open("post_check.jsdp","우편번호 검색","width=150 heigth=150 scrollbars=yes")
}
</script>
...
<tr>
  ...
  <td width="80%" valign="top">&nbsp;<img src="./img/title1.gif" ><br>    
	<form name=member method=post actioun = userinfo_insert_pro.jsp>
			...
			<table cellpadding=0 cellspacing=0 border=0 width=650 align=center>       
				<tr>
                 ...
                 6~12자 이내의 영문이나 숫자만 가능합니다.
                  		...
                  		<td>
      									<a href = "#" onClick="post_check()"><img src="./img/u_bt07.gif" hspace=2 border=0 name=img2 align=absmiddle>
      									</a>
 											</td>
										</tr>
									</table>
