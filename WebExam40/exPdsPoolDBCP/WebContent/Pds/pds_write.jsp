	...
	<table border="0" width="800">
		<tr>
			...
			<td width="80%" valign="top">&nbsp;<br> <img
				src="Pds/img/bullet-01.gif"><font size="3" face="돋움"
				color="blue"> <b>참 좋은 자료실</b></font> <font size="2"> - 자료올리기</font>
			<p>
					<img src="Pds/img/bullet-03.gif"><font size="2" face="돋움"
						color="orange"> 잠깐</font> &nbsp; <img src="Pds/img/bullet-02.gif"><font
				...
				<form name="pds" method="post" action="pds_write" encType="multipart/form-data">
					<table border="0">
						...
						<td align=center><a href="javascript:document.pds.submit();"><img
								src="Pds/img/purple_save.gif" width="56" height="18" border="0"></a>
							<a href="javascript:history.back"><img src="Pds/img/purple_cancle.gif" width="56"
