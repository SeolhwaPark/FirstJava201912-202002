...
<div class="contain">
	...
	<div class="write-form">
		...
		<c:forEach var= "vo" items="${list}">
			<form name="my" method="post" action="study_modify" enctype="multipart/form-data" onsubmit="return send();">
					...
					<br>
						<td colspan="2">
							...
							<input type="button" value="목록"  class="btn-reset" onclick="javascript:location.href='study_main'">
						</td>
					</tr>
				</form>
