 ...
 -->
	...
	<div class="container">
		<div class="board_view">
			...
			<p class="info"><span class="user">홍길동</span> | 2018-10-18 | <i class="fa fa-eye">
			</i> 321</p>
			...
			<div class="prev_next">
				...
				<div class="btn_3wrap">
					<a href="notice">목록</a> <a href="notice_modify">수정</a> 
					<a href="notice_delete" onClick="return confirm('삭제하시겠어요?')">삭제</a>
				</div>
