...
<div class="contain">
	<div class="sub-topcontent">
		<h2 class="sub-title">Web Programming</h2>


		<div class="sub-search">
			<form name="my" method="post" action="web_list" onsubmit="return check()">
...
<c:forEach var= "vo" items="${list}">
	...
	<div class="sub-view-bottom">
		<a href="web_write" class="btn-write">작성</a> 
