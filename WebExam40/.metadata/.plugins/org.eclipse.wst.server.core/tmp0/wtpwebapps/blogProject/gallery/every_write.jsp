...
<div class="contain">
	...
	<div class="write-form">
		<table summery="글쓰기 테이블 입니다">
			...
			<tbody>
			<form name="my" method="post" action="every_write" enctype="multipart/form-data" onsubmit="return formcheck();">
					<tr>
						<th>작성자</th>
					...
					<tr>
						<td colspan="2">
							...
							<input type="button" value="목록"  class="btn-reset" onclick="javascript:location.href='every_list'">
						</td>
					</tr>
				</form>
			</tbody>
