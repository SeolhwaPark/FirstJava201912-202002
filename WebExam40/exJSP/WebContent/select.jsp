...
<body>
	<center>
		...
		<div class="section">
			<section>
				<h2 class="title" color="#e198b4">생산관리 현황</h2>
				<div class="contents">

					<table width="800" border="1" bordercolor="#fdeff2">
						<tr>
							<td style="width:100; color:#fdeff2; 
	background-color:#e198b4;border:0 solid #fdeff2">제품코드</td>
							<td style="width:100; color:#fdeff2; 
	background-color:#e198b4;border:0 solid #fdeff2">제품이름</td>
							<td style="width:100; color:#fdeff2; 
	background-color:#e198b4;border:0 solid #fdeff2">제품원가</td>
							<td style="width:100; color:#fdeff2; 
	background-color:#e198b4;border:0 solid #fdeff2">목표수량</td>
							<td style="width:100; color:#fdeff2; 
	background-color:#e198b4;border:0 solid #fdeff2">재고수량</td>
							<td style="width:100; color:#fdeff2; 
	background-color:#e198b4;border:0 solid #fdeff2">출고가</td>
							<td style="width:100; color:#fdeff2; 
...
<%while(rs.next()){ %>
						<tr>
							<td style="width:100; color:#fdeff2; background-color:#e198b4;border:0 solid #fdeff2">
		<a href ="search.jsp?code=<%=rs.getString("code") %>"><%=rs.getString("code") %></a></td
		>
							<td style="width:100; color:#fdeff2; background-color:#e198b4;border:0 solid #fdeff2">
		<a href ="search.jsp?pname=<%=rs.getString("pname") %>"><%=rs.getString("pname") %></a></td>
		
							<td style="width:100; color:#fdeff2; 
	background-color:#e198b4;border:0 solid #fdeff2"><%=rs.getInt("cost") %></td>
							<td style="width:100; color:#fdeff2; 
	background-color:#e198b4;border:0 solid #fdeff2"><%=rs.getInt("pnum") %></td>
							<td style="width:100; color:#fdeff2; 
	background-color:#e198b4;border:0 solid #fdeff2"><%=rs.getInt("jnum") %></td>
							<td style="width:100; color:#fdeff2; 
	background-color:#e198b4;border:0 solid #fdeff2"><%=rs.getInt("sale") %></td>
							<td style="width:100; color:#fdeff2; 
	background-color:#e198b4;border:0 solid #fdeff2"><%=rs.getString("gcode") %></td>
<%} %>
						</tr>
					</table>
