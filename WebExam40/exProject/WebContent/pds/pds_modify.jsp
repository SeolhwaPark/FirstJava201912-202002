...
<html lang="ko">
 ...
 -->
			...
			<div class="gnb_group">
				...
				<nav class="gnb">
					<ul class="nav_1depth">
						...
						<li><a href="pds">커뮤니티</a>
							<ul class="nav_2depth">
								<li><a href="pds">공지사항</a></li>
	...
	<div class="container">
	  ...
	  <form name="pds" method="post" action="pds_insert" onsubmit="return check()">
	  <!-- action을 처리하기전에 check()사용자 함수를 실행하고 되돌아 와라-->
			...
			<div class="btn_wrap">
				...
				<input type="button" value="목록" class="btn_list" onClick="location.href='pds';">
			</div>
		</form>
	  </div>
