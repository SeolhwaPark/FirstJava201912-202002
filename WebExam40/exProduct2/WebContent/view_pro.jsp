...
<div class = "section">
	...
	<section>
		...
		<div class="contents">
			...
			<form name="insert" method="post" action="view.jsp">
			
			<table>
				<tr>
					<th class="thh">제품코드</th>
					<td class="tdd"><input type="text" name="code" value="<%= vo.getCode()%>"></td>
				</tr>
				<tr>
					<th class="thh">제품이름</th>
					<td class="tdd"><input type="text" name="pname" value="<%= vo.getPname()%>"></td>
				</tr>
				<tr>
					<th class="thh">제품원가</th>
					<td class="tdd"><input type="text" name="cost" value="<%= vo.getCost()%>"></td>
				</tr>
				<tr>
					<th class="thh">목표수량</th>
					<td class="tdd"><input type="text" name="pnum" value="<%= vo.getPnum()%>"></td>
				</tr>
				<tr>
					<th class="thh">재고수량</th>
					<td class="tdd"><input type="text" name="jnum" value="<%= vo.getJnum()%>"></td>
				</tr>				
				<tr>
					<th class="thh">출고가</th>
					<td class="tdd"><input type="text" name="sale" value="<%= vo.getSale()%>"></td>
				</tr>				
				<tr>
