...
<tr>
  ...
  <td width="80%" valign="top">&nbsp;<br>    
	<form name=jform method=post action=modify>
					...
					<td bgcolor="#7AAAD5">            
						<table cellpadding=0 cellspacing=0 border=0 width=100%>
							<tr bgcolor=#7AAAD5>
								...
								<td align=center bgcolor="#7AAAD5"><FONT COLOR="#FFFFFF"><b>사용자 정보수정&nbsp;</b><font color=black>(</font><font color=red>&nbsp;*&nbsp;</font><font color=black>표시항목은 반드시 입력하십시요.)</font></FONT></td>
