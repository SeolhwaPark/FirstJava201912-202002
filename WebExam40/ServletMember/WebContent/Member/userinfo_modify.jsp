...
<tr>
  ...
  <td width="80%" valign="top">&nbsp;<img src="Member/img/title1.gif" ><br>    
	<form name=modify method=post action = "userinfo_insert">
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td align=absmiddle>
												<input type=text name=userid size=12 maxlength=16 value="<%=vo.getUserid()%>" style="width:120">
											</td>
											<td>
              ...
              <tr>
                ...
                <TD BGCOLOR=WHITE>
                  <select name=job class="formbox">
 										...
 										<option value="종교,언론,에술인"<%if(vo.getJob().equals("종교,언론,예술인")){%> selected <% }%>>종교.언론/예술인
