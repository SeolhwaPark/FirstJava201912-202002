			...
			<td width="80%" valign="top"><br>
				<table border="0" cellspacing="1" width="100%" align="center">
					<tr>
						<td colspan="7" align="center" valign="center" height="20"><font
							size="4" face="돋움" color="blue"> <img
								src="Pds/img/bullet-01.gif"> <b>참 좋은 자료들</b></font></td>
					</tr>
					<tr>
						<td colspan="7" align="right" valign="middle" height="20"><font
							size="2" face="고딕">전체 : <b>${totcount}</b>건
						</font></td>
					</tr>
					<tr bgcolor="e3e9ff">
					...
					<c:forEach items="${list}" var="pds">
						...
						<td align="left" height="20">&nbsp;<font face="돋움" size="2"><a href = "pds_view?idx=${pds.idx}">${pds.subject}</font></td></a>
							<td align="center" height="20"><a href = "./upload/${pds.filename}"download><font face="돋움" size="2">${pds.filename}</a></td>
					...
					<tr>
						<td colspan="5" align="center"><font face="돋움" size="2"
							color="#000000">[1][2][3]</td>
					</tr>
					<tr>
						<td colspan="7" align="right"><a href="pds_write"><img
								src="Pds/img/write.gif" alt="자료등록" align="middle" border="0"></a>
							&nbsp;</td>
					</tr>
						...
						<tr>
							<td><center>
									...
									<select name="search" size="1" style="font-family: 돋움체">
										...
										<option>작성자</option>
										<option>글내용</option>
									</select> &nbsp;&nbsp;<input type="text" name="query" size="20">
									&nbsp;&nbsp;<input type="image" src="Pds/img/search2.gif"
										align="middle"></td>
						</tr>
					</table>
				</table></td>
