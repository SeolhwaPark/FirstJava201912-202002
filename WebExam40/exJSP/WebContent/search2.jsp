		...
		<div class="section">
			<section>
				...
				<div class="contents">
					...
					<form name="input" method="post" action="search2.jsp">
						<table>
							...
							<td><select name="gcode">
									...
									<option value="A" <%if (gcode.equals("A")) {%> selected <%}%>>컴퓨터</option>
									<option value="B" <%if (gcode.equals("B")) {%> selected <%}%>>냉장고</option>
									<option value="C" <%if (gcode.equals("C")) {%> selected <%}%>>냉장소품</option>
							</select></td>
							</tr>

							<tr>
								<td colspan="2"><input type="button" value="조회하기"
