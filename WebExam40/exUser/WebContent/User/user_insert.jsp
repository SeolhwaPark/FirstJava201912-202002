...
<script type="text/javascript">
	function id_check() {
		window.open("id_check", "id_check form", "width=200 height=130");
	}
	...
	function mailcheck() {//메일주소체크하면 그 멜주소들어가게하기
		i = document.form_name.email3.selectedIndex // 선택항목의 인덱스 번호
		var mail = document.form_name.email3.options[i].value // 선택항목 value
		document.form_name.email2.value = mail
	}
</script>
</head>
	...
	<table border="0" width="800">
		<tr>
			...
			<td width="80%" valign="top">&nbsp;<img
				src="User/img/title1.gif"><br>
				<form name=form_name method=post action=user_insert>
											...
											<table cellpadding=3 cellspacing=1 border=0 width=100%>
													...
													<TD BGCOLOR=WHITE>
														<table cellspacing=0 cellpadding=0>
															<tr>
																...
																<td>
																	<!--  아이디중복체크--> <a href="javascript:id_check()"><img
																		src="User/img/u_bt01.gif" hspace=2 border=0 name=img1
																		align=absmiddle></a> 5~16자 이내의 영문이나 숫자만 가능합니다.
																</td>
															</tr>
														</table>
													</td>
												...
												<tr>
													...
													<td bgcolor=WHITE valign=middle><input type="text"
														...
														name="email3" onChange="mailcheck()">
															<!-- 변화가 있을 때 입력칸에 삽입되게 함 -->
															<option value="">직접입력</option>
															<option value="naver.com">naver.com</option>
															<option value="daum.net">daum.net</option>
															<option value="nate.com">nate.com</option>
															<option value="gmail.com">gmail.com</option>
													</select> <input type="button" value="인증하기" onClick="email_check()"></td>
												</tr>
											</table>
											<table cellpadding=0 cellspacing=0 border=0 width=100%>
												<tr bgcolor=#7AAAD5>
													<td valign=bottom><img src="User/img/u_b04.gif"
														align=left hspace=0 vspace=0 border=0></td>
													<td align=center></td>
													<td valign=bottom><img src="User/img/u_b05.gif"
														align=right hspace=0 vspace=0 border=0></td>
												</tr>
												<tr bgcolor=#ffffff>
													<td colspan=3 align=center><a href="javascript:send()"><img
															src="User/img/u_bt06.gif" vspace=3 border=0 name=img3></a>
														<a href="javascript:reset()"><img
															src="User/img/u_bt05.gif" border=0 hspace=10 vspace=3
															name=img4></a></td>
												</tr>
											</table>
										</td>
