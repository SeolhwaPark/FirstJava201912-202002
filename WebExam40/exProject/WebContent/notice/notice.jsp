	  ...
	  <div class="bord_list">
		<table class="bord_table" summary="이표는 번호,제목,글쓴이,날자,조회수로 구성되어 있습니다">
			...
			<tbody>
				<tr>
					<td>8</td>
					<td class="title"><a href="notice_view">입학절차에 대하여 알고 싶어요</a></td>
					<td>관리자</td>
					<td>18-10-16</td>
					<td>187</td>
				</tr>
				<tr>
					<td>7</td>
					<td class="title"><a href="notice_view">무엇이 궁금한가요?</a></td>
					<td>관리자</td>
					<td>18-10-16</td>
					<td>187</td>
				</tr>
				<tr>
					<td>6</td>
					<td class="title"><a href="notice_view">궁굼한내용제목입니다</a></td>
					<td>관리자</td>
					<td>18-10-16</td>
					<td>187</td>
				</tr>
		...
		<div class="paging">
			...
			<a href="notice_write" class="btn_write">글쓰기</a>
		</div>
	  </div>
	</div>
	<!-- end contents -->
