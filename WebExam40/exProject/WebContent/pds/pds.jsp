	...
	<div class="container">
	  <div class="search_wrap">
		...
		<div class="search_group">
			<form name="myform" method="get" action="notice">
				...
				</i><span class="sr-only">검색버튼</span></button>
			</form>
		</div>
	  </div> <!-- search end -->
	  <div class="bord_list">
		<table class="bord_table" summary="이표는 번호,제목,글쓴이,날자,조회수로 구성되어 있습니다">
			...
			<tbody>
				<tr>
					<td>8</td>
					<td class="title"><a href="pds_view">JAVA API문서</a></td>
				...
				<tr>
					<td>7</td>
					<td class="title"><a href="pds_view">이클립스 엔터프라이즈 버젼</a></td>
					<td><img src="../images/file.png"></td>
					<td>관리자</td>
					<td>18-10-16</td>
					<td>187</td>
				...
				<tr>
					<td>6</td>
					<td class="title"><a href="pds_view">정보처리 필기 과년도 기출문제</a></td>
					<td><img src="../images/file.png"></td>
					<td>관리자</td>
					<td>18-10-16</td>
					<td>187</td>
		...
		<div class="paging">
			...
			<a href="pds_write" class="btn_write">글쓰기</a>
		</div>
	  </div>
	</div>
	<!-- end contents -->
