...
<%@ include file="header.jsp" %>
	...
	<div class="slider">
	    <div><img src="" alt="" title="배움의 즐거움이 있는곳"></div>
	...
	<div class="indexgallery">
			<div class="indextitle">
				<h2>Schneeblume<br>갤러리</h2>
				<span><a href="gallery.jsp">MORE</a></span>
			</div>
			<ul>
	...
	<div class="bbs_wrap">
		<div class="bbs_left">
			...
			<a href="notice.jsp"><span class="fa fa-plus plus"></span></a>
		</div>
		<div class="bbs_right">
			...
			<a href="qa.jsp"><span class="fa fa-plus plus"></span></a>
		</div>
	</div>
