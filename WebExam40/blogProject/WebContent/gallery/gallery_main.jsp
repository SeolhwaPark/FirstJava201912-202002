...
<div class="sub-topcontent">
		<h2 class="sub-title">Seolhwa's Gellary</h2>
			<br></div>
...
<c:if test="${!empty list}">
		...
		<ul>
			<li><a href="every_view?idx=${vo.idx}">
...
<c:if test="${!empty list2}">
		...
		<ul>
			<li><a href="illust_view?idx=${vo2.idx}">
		...
		<c:forEach var="vo3" items="${list3}">
			<c:if test="${'Seolhwa' eq sessionScope.id}">
				...
				<div class="sub-view-bottom">
					<a href="gallery_modify?idx=${vo3.idx}" class="btn-modify">수정</a> 
					<a href="gallery_delete?idx=${vo3.idx}" class="btn-delete">삭제</a>
				</div>
